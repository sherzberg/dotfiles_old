...
beautiful.init(home_dir .. "/.config/awesome/themes/daes/theme.lua")
...
cpuicon.image = image(home_dir .. "/.config/awesome/themes/daes/icons/cpu.png")
...
memicon.image = image(home_dir .. "/.config/awesome/themes/daes/icons/mem.png")
